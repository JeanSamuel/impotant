...
import sendSyle from "../../styles/stylesC/sendStyle";
...
class Send extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      loading: true,
      solde: 0,
      bodyLoadingMessage: "Chargement du lecteur QR Code",
      isEditable: true
    };
  }
  ...
  performTransaction() {
    this.setState({
      loading: true,
      bodyLoadingMessage: "Validation de la transaction"
    });
    this.removeModal();
    ...
    if (hasCameraPermission === null) {
      ...
      return (
        <MinimLoading
          ...
          loadingText="Verification de la permission"
        />
      );
      ...
      return (
        <View style={styles.container}>
          <MinimLoading
            ...
            onRequestClose={() => console.log("Fermer")}
            loadingText={this.state.bodyLoadingMessage}
          />
          <View style={{ flex: 1 }}>
            <BarCodeScanner
