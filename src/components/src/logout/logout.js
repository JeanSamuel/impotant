...
import { View, Text, StyleSheet, Keyboard, Modal, Dimensions, TouchableOpacity, ScrollView } from 'react-native';
...
class Logout extends Component{
    ...
    static navigationOptions = {
        title : 'Logout',
        drawerIcon : ({tintColor}) => <Icon name="logout" size= {25} type={'material-community'} />,
    }
