...
import { View, Text, Image, TextInput, Keyboard, TouchableOpacity, ScrollView} from 'react-native';
        ...
        return (
            <View style = {styleBase.containerBase} >
                <Image style={[styles.header]} source={backHeader} resizeMode="cover">
                    ...
                    <View style = {styleBase.centered} >
                        <Text style = {[styles.logoTextInline, styleBase.textWhiteCentered]}> Ariary.net</Text>
                    </View>
                </Image>
                <ScrollView contentContainerStyle={[styles.data,styleBase.centered]} >
                    <View style={styles.felicitationContainer} >
                        <Text
                            style={[styles.felicitation, styleBase.textCenter]}
                        >Félicitation
                        </Text>
                    </View>
                    <TouchableOpacity
                    ...
                    >
                        <View style={[styles.oneChecked]}>
                            ...
                            <View style={styles.checkTextContainer} >
                                <Text style={styles.checkText} >Nous venons de créer un compte pour vous</Text>
                            </View>
                        </View>
                        <View style={[styles.oneChecked]}>
                            <Image source={check} style={styles.checkImage} />
                            <View style={styles.checkTextContainer} >
                                <Text style={styles.checkText} >Nous avons aussi donné un nom à votre entreprise. Vous pouvez le modifier si vous le souhaiter</Text>
                            </View>
                        </View>
                        <View style={[styles.oneChecked]}>
                            <Image source={check} style={styles.checkImage} />
                            <View style={styles.checkTextContainer} >
                                <Text style={styles.checkText} >D'ici quelques secondes, vous pourrez déjà recevoir de l'argent</Text>
                            </View>
                        </View>
                ...
                <View style={[styleBase.alignCentered,styles.newUserButtonContainer]} >
                    <TouchableOpacity
                        style = {[styles.newUserButton,{backgroundColor:'rgba(230, 126, 34,1.0)'}]}
                        activeOpacity = {0.7}
                        onPress = {this.returnStarter.bind(this)}
                        >
                        <View style={[ styles.buttonContent]}>
                            <Icon name="arrow-back" size= {20} color='#FFF' style={{marginHorizontal : 5}}/>
                            <Text style = {[styleBase.textWhite, styles.buttonText]}>Précédent</Text>
                        </View>
                    </TouchableOpacity>
                    <TouchableOpacity
                        style = {[styles.newUserButton,{backgroundColor:'rgba(230, 126, 34,1.0)'}]}
                        ...
                        >
                        <View style={[ styles.buttonContent]}>
                            <Text style = {[styleBase.textWhite, styles.buttonText]}>Je continue</Text>
                            <Icon name="arrow-forward" size= {20} style={{marginHorizontal : 5}} color='#FFF' />
                        </View>
