		...
		switch (a) {
			case 3+"":
				sms = {
					...
					contenue:
						'Veuillez composer #436#,puis choisissez le menu paiement facture. Le surnom est "ariarynet", suivez les instructions démandées pour la suite'+'. Vous allez recevoir une notification sur votre téléphone une fois que la transaction aura terminée'
				};
				break;
			case 2+"":
				sms = {
					...
					contenue:
						"Veuillez composer #144# puis choisissez le menu paiement marchand. Le code marchand est 103102 et suivez les instructions démandées jusqu'au bout"+'. Vous allez recevoir une notification sur votre téléphone une fois que la transaction aura terminée'
				};
				break;
			case 4+"":
				sms = {
