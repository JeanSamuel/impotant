		...
		return (
			<View style={styles.container}>
				...
				<View style={styles.textbienvenue}>
					<Text style={{paddingLeft: 10,textAlign:'center',flexWrap:'wrap'}}>
						Pour le moment, vous pouvez recevoir de l'argent. Si vous vous voulez benéficiers tous nos services, vous devez completer vos information en vous inscrivant.
					</Text>
				</View>
